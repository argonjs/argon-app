...
#   * Finally, don't worry about the indent, CocoaPods strips it!  
  ...
  s.source_files = 'Source/**/*.{h,m,mm}', 'Vuforia.framework/Headers/*.h'
  s.public_header_files = 'Source/**/*.{h}', 'Vuforia.framework/Headers/*.h'
  s.resources = 'Source/VideoView/shaders/*'
  
  # s.header_dir = 'Vuforia'
  # s.vendored_libraries = 'SDK/lib/arm/libVuforia.a'

  s.vendored_frameworks = 'Vuforia.framework'
