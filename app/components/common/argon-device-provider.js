    ...
    NativescriptDeviceServiceProvider.prototype.onStartGeolocationUpdates = function (options) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            _this.locationWatchId = geolocation.watchLocation(function (location) {
                ...
                _this.configureStage(new Argon.Cesium.Cartographic(location.longitude, location.latitude, location.altitude), location.horizontalAccuracy, location.verticalAccuracy);
            }, function (e) {
                reject(e);
            }, {
